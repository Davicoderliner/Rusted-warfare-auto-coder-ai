...
const placeholderIconBase64 = '';
...
const App: React.FC = () => {
  ...
  const [modIcon, setModIcon] = useState<string | null>(null);
  ...
  const handleSendMessage = useCallback(async () => {
    ...
    try {
      let result;
      if (imageToProcess) {
          // If this is the first unit of the mod, use its image as the mod icon
          if (!currentMod || currentMod.units.length === 0) {
              setModIcon(imageToProcess.dataUrl);
          }
 ...
 const handleUpdateModName = useCallback(async () => {
  ...
  const handleDownload = () => {
    ...
    // Add icon.png for the mod, using custom icon if available
    const iconDataUrl = modIcon ? modIcon : `data:image/png;base64,${placeholderIconBase64}`;
